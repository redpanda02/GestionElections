    ...
    try {
      ...
      setTimeout(() => {
        if (data.role === 'candidate') {
          router.push('/candidatAccueil'); // Vérifier que cette route existe
        } else {
          router.push('/voterDashboard');  // Assurez-vous d'avoir créé cette page ou modifiez le nom de la route
        }
